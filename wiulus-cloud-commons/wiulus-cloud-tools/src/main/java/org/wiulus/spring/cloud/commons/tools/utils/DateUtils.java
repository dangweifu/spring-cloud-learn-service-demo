...
public class DateUtils {
     ...
     * @param format: 格式
     * @return 格式化的时间
     * @author dangweifu@leimingtech.com
     **/
    public static String longToString(long time, String format) {
        Date date = longToDate(time, format);
    ...
    public static void main(String[] args) {
        int monthCompare = dayCompare(stringToDate("2020-08-12 11:59:59",DATE_TIME_PATTERN), new Date());
