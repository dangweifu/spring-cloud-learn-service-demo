...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T> implements BaseService<T> {
    ...
    protected IPage<T> getPage(Map<String, Object> params, String defaultOrderField, boolean isAsc) {
        ...
        if (params.get(Contants.PAGE) != null) {
            curPage = Long.parseLong((String) params.get(Contants.PAGE));
        }
        if (params.get(Contants.LIMIT) != null) {
            limit = Long.parseLong((String) params.get(Contants.LIMIT));
        }
        ...
        //分页参数
        params.put(Contants.PAGE, page);

        //排序字段
        String orderField = (String) params.get(Contants.ORDER_FIELD);
        String order = (String) params.get(Contants.ORDER);

        //前端字段排序
        if (StringUtils.isNotEmpty(orderField) && StringUtils.isNotEmpty(order)) {
            if (Contants.ASC.equalsIgnoreCase(order)) {
